...
{
	public partial class testxc : UIViewController
	{
		public testxc (IntPtr handle) : base (handle)
		{
		}
      string localPath;
      ...
      public override void ViewDidLoad()
      {
         ...
         getListTX.Clicked+= async (sender, e) =>
         {
            Task<int> sizeTask = DownloadHomepageAsync();

            durumF.Text = "loading...";
            bilgiField.Text = "loading...\n";
            resimField.Image = null;

            // await! control returns to the caller
            var intResult = await sizeTask;

            // when the Task<int> returns, the value is available and we can display on the UI
            bilgiField.Text = "Length: " + intResult;

            // effectively returns void
         };

         baslat.TouchUpInside += delegate
         {
            ...
            bilgiField.Text += "DownloadHomepage method continues after Async() call, until await is used\n";
            ...
            bilgiField.Text += "Downloaded the html and found out the length.\n\n";

                  //
                  // download image bytes
            bilgiField.Text += "Start downloading image.\n";
            ...
            bilgiField.Text += "Downloaded the image.\n";
            ...
            resimField.Image = UIImage.FromFile(localPath);
...
//
            ...
            bilgiField
               .Text+= localPath.ToString();
//
                  //
                  // save image to Photo Album using async-ified iOS API
                  ALAssetsLibrary library = new ALAssetsLibrary();     
                  var dict = new NSDictionary();
            var assetUrl = await library.WriteImageToSavedPhotosAlbumAsync(resimField.Image.CGImage, dict);
            bilgiField.Text += "Saved to album assetUrl = " + assetUrl + "\n";
                  ...
                  { 
                     ...
                     { 
                        await t; 
                  bilgiField.Text += "** Downloaded " +  t.Result.Length + " bytes\n";
                     }
                     ...
                     { 
                  bilgiField.Text += "-- Download ERROR: " + exc.Message + "\n";
                     } 
                  }
