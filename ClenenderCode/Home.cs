...
{
   public class Home :  DialogViewController
   {
      ...
      // screens
      protected RootElement calenderListRoot = new RootElement("Takvim ve Haber bildirimleri");

      protected  CalendarListController calendarListScreen;
      protected  EventListController eventListScreen;
      ...
      public Home(): base ( UITableViewStyle.Grouped, null, false)
      {

         Root = calenderListRoot;
         Root.Add ( new Section("Takvim Listesi")
            {
               new StyledStringElement("Takvim",
                  () => { LaunchCalendarListScreen ( EKEntityType.Event ); } ) 

               { Accessory = UITableViewCellAccessory.DisclosureIndicator },
         
               new StyledStringElement("Hatırlatıcılar",
